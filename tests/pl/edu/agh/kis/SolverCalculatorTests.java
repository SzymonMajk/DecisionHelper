...
{
	@Test
	public void testCalculateLowerCriteriaPriorityVector() 
	{
		Double[] data1 = {2.0,5.0,3.0};
		Double[] test1 = SolverCalculator.calculateLowerCriteriaPriorityVector(data1);
		Double[] data2 = {2.0,5.0,3.0,4.0,2.0,5.0};
		Double[] test2 = SolverCalculator.calculateLowerCriteriaPriorityVector(data2);
		Double[] data3 = {0.5,0.25,3.0,0.5,2.0,2.0};
		Double[] test3 = SolverCalculator.calculateLowerCriteriaPriorityVector(data3);
	...
	public void testSumVectorsWithWeights()
	{
		...
		Double[] test2 = SolverCalculator.calculateLowerCriteriaPriorityVector(data2);
		Double[] test3 = SolverCalculator.calculateLowerCriteriaPriorityVector(data3);
		Double[] weights = SolverCalculator.calculateLowerCriteriaPriorityVector(dataWeights);
